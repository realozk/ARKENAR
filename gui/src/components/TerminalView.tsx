  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 px-5 py-4">
        ...
        <span className={`rounded-full px-2.5 py-0.5 text-[11px] font-bold uppercase ${severityClass}`}>{severityLabel}</span>
    ...
    <div className="flex flex-1 flex-col overflow-hidden mx-6 mb-6 rounded-xl border border-border-subtle bg-bg-terminal">
      <div className="flex items-center justify-between px-5 py-3 border-b border-border-subtle">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={onClear}
            className="flex items-center gap-1.5 rounded-lg border border-border-subtle bg-bg-input px-3 py-1.5 text-xs font-medium text-text-muted hover:border-status-critical/40 hover:bg-status-critical/5 hover:text-status-critical transition-all duration-200"
          >
