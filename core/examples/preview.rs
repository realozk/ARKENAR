...
fn main() {
    ...
    let secrets = [
        ...
        (
            "OpenAI API Key",
            "sk-proj-AbCd1234EfGh5678IjKlMnOpQrSt",
        ...
        (
            "Anthropic API Key",
            "sk-ant-AbCd1234EfGh5678IjKlMnOp",
            "/vendor.js",
        ),
        (
            "Hugging Face Token",
        ...
        (
            "JWT",
            "eyJhbGciOiJI.eyJzdWIiOiIx.SflKxwRJSME",
            "/api/session",
        ),
        ("AWS Access Key", "AKIA9XZ3M8RT5GH7K2QW", "/.env.bak"),
        (
            "Stripe Restricted Key",
            "rk_live_AbCd1234EfGh5678IjKlMnOp",
            "/checkout.js",
        ),
    ];
